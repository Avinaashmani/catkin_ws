...
if("TRUE" STREQUAL "TRUE")
  set(visp_camera_calibration_SOURCE_PREFIX /home/avinaash/catkin_ws/src/vision_visp/visp_camera_calibration)
  set(visp_camera_calibration_DEVEL_PREFIX /home/avinaash/catkin_ws/devel/.private/visp_camera_calibration)
  ...
  set(visp_camera_calibration_INSTALL_PREFIX /home/avinaash/catkin_ws/install)
...
if(NOT "/home/avinaash/catkin_ws/devel/.private/visp_camera_calibration/include;/usr/local/include;/usr/include/opencv4;/usr/include/eigen3;/usr/include;/usr/include/libxml2;/usr/include/pcl-1.10;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/libusb-1.0;/usr/include/OGRE;/usr/include/ois " STREQUAL " ")
  set(visp_camera_calibration_INCLUDE_DIRS "")
  set(_include_dirs "/home/avinaash/catkin_ws/devel/.private/visp_camera_calibration/include;/usr/local/include;/usr/include/opencv4;/usr/include/eigen3;/usr/include;/usr/include/libxml2;/usr/include/pcl-1.10;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/libusb-1.0;/usr/include/OGRE;/usr/include/ois")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visp_camera_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/catkin_ws/src/vision_visp/visp_camera_calibration/${idir}'.  ${_report}")
    endif()
    _list_append_unique(visp_camera_calibration_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libvisp_vs.so.3.6.0;/usr/local/lib/libvisp_visual_features.so.3.6.0;/usr/local/lib/libvisp_vision.so.3.6.0;/usr/local/lib/libvisp_tt_mi.so.3.6.0;/usr/local/lib/libvisp_tt.so.3.6.0;/usr/local/lib/libvisp_me.so.3.6.0;/usr/local/lib/libvisp_mbt.so.3.6.0;/usr/local/lib/libvisp_klt.so.3.6.0;/usr/local/lib/libvisp_blob.so.3.6.0;/usr/local/lib/libvisp_sensor.so.3.6.0;/usr/local/lib/libvisp_robot.so.3.6.0;/usr/local/lib/libvisp_io.so.3.6.0;/usr/local/lib/libvisp_imgproc.so.3.6.0;/usr/local/lib/libvisp_gui.so.3.6.0;/usr/local/lib/libvisp_detection.so.3.6.0;/usr/local/lib/libvisp_core.so.3.6.0;/usr/local/lib/libvisp_ar.so.3.6.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/catkin_ws/devel/.private/visp_camera_calibration/lib;/home/avinaash/catkin_ws/devel/lib;/opt/ros/noetic/lib)
